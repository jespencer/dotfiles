...
#| SF: ${tztime US/Pacific %H:%M} | Free: $memfree |  ${exec /home/jason/bin/pacvol.sh display} | $downspeed $upspeed | ${smapi_bat_perc 0}% ${smapi_bat_power 0} | CPU $cpu% [ ${cpu cpu1}.${cpu cpu2}.${cpu cpu3}.${cpu cpu4} ] | ${time %a %d %b | %H:%M} |
...
#  {"full_text": " Mem: $memfree", "color":"\#F3D194"},
  {"full_text": " ${exec /home/jason/bin/pacvol.sh display}","color":"\#6AFFD8", "name":"volume"},
...
#  ${endif}
  {"full_text": " ${execi 1800 /home/jason/bin/update_count.sh} ", "name":"updates"},
...
# {"full_text": " 🎧 ${exec /home/jason/bin/gmusicsong.pm}", "color": "\#FF905C", "name":"music"},
